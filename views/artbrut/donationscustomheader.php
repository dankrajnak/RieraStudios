...
<head>
    ...
    <link href="<?php echo ROOT_PATH?>assets/css/ninja-slider2.css" rel="stylesheet" />
    <script src="<?php echo ROOT_PATH?>assets/js/ninja-slider2.js" type="text/javascript"></script>
