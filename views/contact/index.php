...
<div class="sectiontext" id="contactsectiontext">
		<div class="sectiontitle" id="contactsectiontitle" style="margin-bottom: 40px">
		CONTACT US
		</div>
			...
			<ul>
				<li>
					...
					<div id=contactsectionbodytext>
						...
						<span id="contactsectionbodyinfo">
						samuelriera@cubarte.cult.cu<br/>
						(+53) 7879 1818<br/>
						(+53) 52457911
					</div>
				</li>
