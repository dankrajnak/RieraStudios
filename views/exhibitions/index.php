	...
	<div class="sectiontable" id="exhibitiontable">
		...
		<table class="sectiontablecontent" id="exhibitionsectiontablecontent">
			<tbody>
				<tr>
					<td>
					<a href="/Riera/artbrutartists/JohnnyDepp/">
						<image class="tablepicture" id="exhibitiontablepicture" src="/Riera/assets/images/exhibitions/3x21.jpg">
						</image>
				...
				<tr>
					<td>
					<a href="/Riera/exhibitions/parallelexpressions/">
						<image class="tablepicture" id="exhibitiontablepicture" src="/Riera/assets/images/exhibitions/parallelexpressions.jpg">
						</image>
				...
				<tr>
					<td>
					<a href="/Riera/artbrutartists/JohnnyDepp/">
						<image class="tablepicture" id="exhibitiontablepicture" src="/Riera/assets/images/exhibitions/citiesInMyMind.jpg"></image>
				...
				<tr>
					<td>
					<a href="/Riera/artbrutartists/JohnnyDepp/">
						<image class="tablepicture" id="exhibitiontablepicture" src="/Riera/assets/images/exhibitions/interestelart.jpg"></image>
				...
				<tr>
					<td>
					<a href="/Riera/artbrutartists/JohnnyDepp/">
						<image class="tablepicture" id="exhibitiontablepicture" src="/Riera/assets/images/exhibitions/prince.jpg">
						</image>
				...
				<tr>
					<td>
					<a href="/Riera/artbrutartists/JohnnyDepp/">
						<image class="tablepicture" id="exhibitiontablepicture" src="/Riera/assets/images/exhibitions/outsider2.jpg">
						</image>
				...
				<tr>
					<td>
					<a href="/Riera/artbrutartists/JohnnyDepp/">
						<image class="tablepicture" id="exhibitiontablepicture" src="/Riera/assets/images/exhibitions/simpleart.jpg">
						</image>
